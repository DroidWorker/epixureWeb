import 'package:epixure_web/res/colors.dart';
import 'package:epixure_web/testingEngine/pages/module.dart';
                      ...
                      children: [
                        ...
                        constraints.maxWidth>600?Row(
                          children: [
                            ...
                            Expanded(child: Image.asset('lib/res/images/vitruvian.png'))
                          ],
                        ):Column(
                          children: [
                            Image.asset('lib/res/images/vitruvian.png'),
                        ...
                        constraints.maxWidth>600?Row(
                          children: [
                            Expanded(child:Image.asset('lib/res/images/progress.png')),
                          ...
                          Image.asset('lib/res/images/progress.png'),
                        ...
                        constraints.maxWidth>600?Row(
                          children: [
                            ...
                            Expanded(child:Image.asset('lib/res/images/brain.png')),
                          ],
                        ):Column(children: [
                          Image.asset('lib/res/images/brain.png'),
                        ...
                        Image.asset("lib/res/images/wawefunc.png"),
                        const SizedBox(height: 10.0),
